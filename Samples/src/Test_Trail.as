package {
	...
	import monkey.core.components.Trail3D;
	...
	public class Test_Trail extends Sprite {
		
		[Embed(source="../assets/test_trail/weaponTrail02.jpg")]
		...
		private var trail	: Trail3D;
		
		public function Test_Trail() { 
			super();
			...
			// 刀光			
			this.trail = new Trail3D(new Bitmap2DTexture(new IMG1().bitmapData));
			this.trail.setTime(0.5, 0.5, 1);
			this.trail.height = 100;
			// 偏了90°，需要在重新偏回来
			var node : Object3D = new Object3D();
			node.transform.rotateZ(90);
			node.addComponent(this.trail);
